...
\columnbreak
Haskell\\Eagle Scout\\AWS Cloud Development\\Embedded Systems\\
\columnbreak
	\begin{flushright}
...
\section{Professional Experience}
   ...
   \end{tabbing}\vspace{-10pt}
	\begin{itemize}
		...
		\item Expanded and Maintained a Developer portal used by 18 dev teams which enforced and managed the process of application deployments and provided a dashboard for a near real-time overview and history of deployments and application automation.
		\item Took initiative to Develop a service layer for the Developer Portal to replace our integration with Zapier which increased portal responsiveness and reduced costs paid to Zapier.
		\item Developed the companies first AWS based api for storing data in the cloud with \vspace{-15pt}
	\end{itemize}
   \begin{tabbing}
   \hspace{5.5in}\= \kill
...
{Eagle Scout\\ Profession Scrum Master I (Scrum.org)}\vspace{-10pt}
\section{Projects}          
