...
\section{Professional Experience}
   ...
   \end{tabbing}\vspace{-10pt}
	\begin{itemize}
		...
		\item Took initiative to build a service layer for the Developer Portal to replace our integration with Zapier which increased portal responsiveness and reduced costs paid to Zapier.
